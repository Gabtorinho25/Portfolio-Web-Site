Bien sûr, voici le code avec des commentaires en français directement dans le code :
...
require 'C:\MAMP\htdocs\Portfolio\PHPmailer\src\Exception.php';
require 'C:\MAMP\htdocs\Portfolio\PHPmailer\src\PHPMailer.php';
require 'C:\MAMP\htdocs\Portfolio\PHPmailer\src\SMTP.php';
?>
...
try {
    ...
    $mail->Username   = 'portfoliogdsnts@gmail.com';   // Nom d'utilisateur SMTP
    $mail->Password   = 'xlayzkwfuiukzdqp'; // Mot de passe de l'application
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;    // Activer le TLS implicite 
    ...
    $mail->addAddress('portfoliogdsnts@gmail.com'); // E-mail indiqué dans le formulaire
