...
<?php
require_once('D:\XAMP\htdocs\PortfolioTEST\config.php');
...
try {
    ...
    $mail->Username   = USERNAME;   // Nom d'utilisateur SMTP / celui qui va envoyer le mail
    $mail->Password   = PASSWORD ; // Mot de passe de l'application
    $mail->SMTPSecure = 'ssl';    // Activer le TLS implicite 
    $mail->Port       = PORT ; //  Port 465 SMTP
    ...
    $mail->addAddress(USERNAME); // Qui va recevoir le mail
