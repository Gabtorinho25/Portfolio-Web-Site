...
onglets.forEach((onglet) => {
    //a chaque fois qu'on clique on vérifie sur l'onglet où l'on a cliqué possède la class "displayed". Si l'onglet le possède on sort de la boucle et s'il ne le possède pas on ajoute la 
