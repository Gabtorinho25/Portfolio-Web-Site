...
onglets.forEach((onglet) => {
  ...
  onglet.addEventListener("click", () => {
    ...
    //Ici on fait une boucle qui s'arrête lorsqu'on dépasse le nombre d'élément dans le tableau 'onglets'. Cette boucle va permettre de parcourir tous les 'onglet' et de prendre la valeur de l'élément "data-anim"
